...
function setDraggability (node, value) {
...
function cloneDOM (nodeToBeCloned) {
    var newTree, subTrees, customTagName, childNodes, customElement, clone;
...
function elementToTagName (element) {    
    const regex = /[ >]/;
...
function isComplexCustomElement (tagName) {
...
function appendHTML (location, html) {
    return $(location).append(html);
}

function elementTag (elem) {
...
function removeCustomElement (elem) {
    console.group("elem");
